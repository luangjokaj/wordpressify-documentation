...
- **Header Scripts:** Include scripts in the head of the page to load before the DOM is rendered by adding them to the <code>headerJS</code> array.
- **Footer Scripts:** Place scripts in the footer of the page to load after the DOM is loaded by utilizing the <code>footerJS</code> array. Only footer scripts undergo processing with Babel, supporting ES6. However, you can configure this behavior to apply Babel to both header and footer scripts if needed.
