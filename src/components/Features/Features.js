...
import { OverflowHidden } from "../Layout/OverflowHidden";
			...
			<OverflowHidden>
				<Row gutterLg="big">
					...
					<Col xs={6} lg={4} textAlign="center">
						...
						<p>
							A development server for PHP and MariaDB database
							out of the box.
						</p>
						<Space xs={20} lg={40} />
					</Col>
					<Col xs={6} lg={4} textAlign="center">
						...
						<p>
							Watches for all your changes and reloads in
							real-time.
						</p>
						<Space xs={20} lg={40} />
					</Col>
					...
					<Col xs={6} lg={4} textAlign="center">
						...
						<p>
							Babel compiler for writing next generation
							JavaScript.
						</p>
						<Space xs={20} lg="none" />
					</Col>
					<Col xs={6} lg={4} textAlign="center">
						...
						<p>
							Easy import for external JavaScript libraries and
							npm scripts.
						</p>
					</Col>
					<Col xs={6} lg={4} textAlign="center">
